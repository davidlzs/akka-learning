...
public class WeatherRoutes {
    ...
    private final Unmarshaller<String, WeatherStation.Function> functionUnmarshaller = Unmarshaller.sync(text -> {
        ...
        switch (lcText) {
            case "current":
                return WeatherStation.Function.Current;
            case "highlow":
                return WeatherStation.Function.HighLow;
            case "average":
                return WeatherStation.Function.Average;
            default:
    ...
    private final Unmarshaller<String, WeatherStation.DataType> dataTypeUnmarshaller = Unmarshaller.sync(text -> {
        ...
        switch (lcText) {
            case "temperature":
                return WeatherStation.DataType.Temperature;
            case "dewpoint":
                return WeatherStation.DataType.DewPoint;
            case "pressure":
                return WeatherStation.DataType.Pressure;
            default:
